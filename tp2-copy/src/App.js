	...
	return (
		<BrowserRouter>
			...
			<Routes>
				...
				<Route path="/products/:id" element={ <ProductDetail products={products} onDelete={deleteProduct} /> } />
				<Route path="/product-edit/:id" element={ <EditProduct products={products} onProductUpdate={handleProductUpdate} /> } />
			</Routes>
			<Footer />
		</BrowserRouter>
	);
